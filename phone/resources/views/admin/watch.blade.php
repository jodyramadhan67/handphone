            ...
            <div class="modal-content">
                <form method="post" :action="actionUrl" autocomplete="off" @submit="submitForm($event, watch.id)">
                    <div class="modal-header">
                        <h4 class="modal-title">All electronic</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Total</label>
                            <input type="number" name="series" class="form-control" placeholder="Enter total" required="" :value="watch.series">
                        </div>
                        <div class="form-group">
                            <label>Type</label>
